...
const routesAndMenuItems = {
  ...
  sidebarItems: [
    ...
    {
      path: `${appAdmin}/report`,
      exact: true,
      redirect: true,
      to: `${appAdmin}/report/list`,
      label: 'Report',
      icon: 'diagram-1',
      roles: [USER_ROLE.Admin],
      subs: [{ path: '/list', label: 'All Categories', component: reports }],
    },
    {
    ...
    },
    {
      ...
      exact: true,
      redirect: true,
      to: `${appSeller}/advertisement/dashboard`,
      label: 'Advertisement',
      icon: 'radio',
      roles: [USER_ROLE.Seller],
      subs: [{ path: '/dashboard', label: 'Dashboard', component: sellerAd.dashboard }],
    },
