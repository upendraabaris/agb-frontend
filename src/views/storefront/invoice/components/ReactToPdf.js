              ...
              <div ref={componentPDF} className="check" style={{ width: '100%', margin: '40 px', fontWeight: 'bold' }}>
                {invoiceData && (
                  <div style={{ marginTop: '10px', marginLeft: '30px', marginRight: '30px', marginBottom: '40px', fontWeight: 'bold' }}>
                    ...
                    {((invoiceData?.couponName && couponDiscount1 > 0) || invoiceData?.dmtPaymentDiscountPercentage > 0) && (
                      <table
                          ...
                          <tr>
                            <td style={{ padding: '6px', verticalAlign: 'top' }}>
                              {(() => {
                                ...
                                const dmt =
                                  invoiceData?.dmtPaymentDiscountPercentage > 0 ? ((total - coupon) * invoiceData.dmtPaymentDiscountPercentage) / 100 : 0;
                                ...
                                return (
                                  <div style={{ lineHeight: '1.5', color: '#212529' }}>
                                    ...
                                    <div className="small">
                                      (This section is provided for your reference. It shows the total billed amount and the amount paid.)
                                    </div>
                                  </div>
                                );
                              })()}
