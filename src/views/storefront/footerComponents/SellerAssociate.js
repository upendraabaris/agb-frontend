...
//         <span className='mb-1 fw-bold'>Seller Associate</span>
//       </h1>
//       <div className="row">
//         <div className="col-12 col-md-2 d-none d-md-block">
//           <div className="w-100 m-2 pb-2 border-bottom">
//             <NavLink to="/seller_associate" className="fw-bold">
//               Seller Associate
//               <span className="float-end"> <CsLineIcons icon="chevron-right" /> </span>
//             </NavLink>
//           </div>
//           <div className="w-100 m-2 pb-2 border-bottom">
//             <NavLink to="/serviceProviderAssociate" className={({ isActive }) => `fw-bold ${isActive ? 'text-primary bg-light' : 'text-dark'}`}>
//               Service Provider Associate
//               <span className="float-end"> <CsLineIcons icon="chevron-right" /> </span>
//             </NavLink>
//           </div>
//           <div className="w-100 m-2 pb-2 border-bottom">
//             <NavLink to="/tradeAssociate" className={({ isActive }) => `fw-bold ${isActive ? 'text-primary bg-light' : 'text-dark'}`}>
//               Seller Associate
//               <span className="float-end"> <CsLineIcons icon="chevron-right" /> </span>
//             </NavLink>
//           </div>
//           <div className="w-100 m-2 pb-2 border-bottom">
//             <NavLink to="/businessAssociate" className={({ isActive }) => `fw-bold ${isActive ? 'text-primary bg-light' : 'text-dark'}`}>
//               Business Associate
//               <span className="float-end"> <CsLineIcons icon="chevron-right" /> </span>
//             </NavLink>
//           </div>
...
//             <div className="w-100 m-2 pb-2 border-bottom">
//               <NavLink to="/seller_associate" className="fw-bold"> Seller Associate
//                 <span className="float-end"> <CsLineIcons icon="chevron-right" /> </span>
//               </NavLink>
//             </div>
//             <div className="w-100 m-2 pb-2 border-bottom">
//               <NavLink to="/serviceProviderAssociate" className="fw-bold">
//                 Service Provider Associate
//                 <span className="float-end"> <CsLineIcons icon="chevron-right" /> </span>
//               </NavLink>
//             </div>
//             <div className="w-100 m-2 pb-2 border-bottom">
//               <NavLink to="/tradeAssociate" className="fw-bold">
//                 Seller Associate
//                 <span className="float-end"> <CsLineIcons icon="chevron-right" /> </span>
//               </NavLink></div>
//             <div className="w-100 m-2 pb-2 border-bottom">
//               <NavLink to="/businessAssociate" className="fw-bold">
//                 Business Associate
//                 <span className="float-end"> <CsLineIcons icon="chevron-right" /> </span>
//               </NavLink>
//             </div>
...
function PrivacyPolicy() {
  ...
  return (
    <div className="bg-white">
      ...
      <h1 className="mb-1 p-2 text-black mark text-center rounded">
        <span className='mb-1 fw-bold'>Seller Associate</span>
      </h1>
