...
function BusinessAssociate({ history }) {
  ...
  const baStatus = data?.getProfile?.seller?.businessAssociate;
  const userEmail = data?.getProfile?.email;
  const isLoggedIn = Boolean(data?.getProfile);

  const [captchacode, setCaptchaCode] = useState('');

  useEffect(() => {
    if (isLoggedIn && baStatus === undefined) {
      setTimeout(() => {
  ...
  return (
    <div className="bg-white">
      <h1 className="mb-1 p-2 mark text-center rounded">
        <span className="mb-1 fw-bold text-dark">Business Associate Registration Form</span>
      </h1>
        ...
        <div className="tab-container-responsive border rounded p-2 pb-4">
                ...
                <div className="card-body p-4">
                  {baStatus === true && (
                    <>
                      ...
                      <p className="mb-4">
                        You are our valued <strong>Business Associate</strong>. You are already connected with us.
                  ...
                  {baStatus === false && <div className="alert alert-warning fw-bold">Under Review</div>}
                  {baStatus === undefined && (
                    <>
                      <Card className="mb-4 py-2 border mark">
                        {/* 🔽 YAHAN AAPKA POORA FORM JSX AAYEGA */}
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-6 mb-2">
                                <div className="fw-bold p-1">
                                  ...
                                  <OverlayTrigger
                                    placement="top"
                                    overlay={<Tooltip id="firm-desc-tooltip">Enter your valid GST number for verification and billing purposes.</Tooltip>}
                                  >
                                    <span className="ms-1 text-dark" style={{ cursor: 'pointer' }}>
                                      <CsLineIcons icon="info-hexagon" size={14} />
                                    </span>
                              ...
                              <div className="col-md-6 mb-2 ">
                                <div className="fw-bold p-1">
                                  ...
                                  <OverlayTrigger
                                    placement="top"
                                    overlay={<Tooltip id="firm-desc-tooltip">Enter the complete business address of your firm.</Tooltip>}
                                  >
                                    <span className="ms-1 text-dark" style={{ cursor: 'pointer' }}>
                                      <CsLineIcons icon="info-hexagon" size={14} />
                                    </span>
                              ...
                              <div className="col-md-6 mb-2 ">
                                <div className="fw-bold p-1">
                                  ...
                                  <OverlayTrigger
                                    placement="top"
                                    overlay={<Tooltip id="firm-desc-tooltip">Enter the city where your firm is located.</Tooltip>}
                                  >
                                    <span className="ms-1 text-dark" style={{ cursor: 'pointer' }}>
                                      <CsLineIcons icon="info-hexagon" size={14} />
                                    </span>
                              ...
                              <div className="col-md-6 mb-2">
                                <div className="fw-bold p-1">
                                  ...
                                  <OverlayTrigger
                                    placement="top"
                                    overlay={<Tooltip id="firm-desc-tooltip">Select the state where your firm is registered.</Tooltip>}
                                  >
                                    <span className="ms-1 text-dark" style={{ cursor: 'pointer' }}>
                                      <CsLineIcons icon="info-hexagon" size={14} />
                                    </span>
                                  ...
                                  <div className="col-md-3 mb-2">
                                    <div className="border rounded p-2 mb-2">
                                      <div className="d-flex align-items-center">
                                        ...
                                        <button type="button" className="btn   btn-sm ms-auto" onClick={() => loadCaptchaEnginge(6)} title="Reload Captcha">
                                          🔄
                                        </button>
                                      </div>
          ...
          <Modal show={showSuccessModal} onHide={() => setShowSuccessModal(false)} centered backdrop="static" className="success-modal">
            ...
            <Modal.Body className="text-center">
              <div className="fs-5 text-dark fw-bold w-100">Your "Business Associate" form has been submitted successfully.</div>
              <div className="text-dark pt-2">Our team will inform you about the next steps email within 2 to 5 working days.</div>
            </Modal.Body>
