...
//     getContent({
//       variables: {
//         key: 'serviceproviderassociatedes',
//       },
//     });
...
//         <span className='mb-1 fw-bold'>Service Provider Associate</span>
//       </h1>
//       <div className="row">
...
//             </div>
//             <div className="w-100 m-2 pb-2 border-bottom">
//               <NavLink to="/shipping_policy" className="fw-bold">
//                 Shipping Policy
//                 <span className="float-end"> <CsLineIcons icon="chevron-right" /> </span>
//               </NavLink>
//             </div>
//             <div className="w-100 m-2 pb-2 border-bottom">
//               <NavLink to="/return_policy" className="fw-bold">
//                 Return Policy
//                 <span className="float-end"> <CsLineIcons icon="chevron-right" /> </span>
//               </NavLink></div>
//             <div className="w-100 m-2 pb-2 border-bottom">
//               <NavLink to="/cancellation_policy" className="fw-bold">
//                 Cancellation Policy
//                 <span className="float-end"> <CsLineIcons icon="chevron-right" /> </span>
//               </NavLink>
//             </div>
