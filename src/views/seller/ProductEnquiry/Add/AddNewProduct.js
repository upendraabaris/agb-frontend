...
`;
  ...
  const [CreateProduct] = useMutation(CREATE_PRODUCT, {
    onCompleted: () => {
      ...
      setTimeout(() => {
        history.push('/seller/productenquiry/list');
      }, 3000);
    },
    onError: (error) => {
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/seller/productenquiry/list">
             
              <span className="align-middle text-small ms-1">Product Enquiry List</span>
            </NavLink>
            <span className="p-2 small fw-bold text-dark"> / </span>
            <span className="align-middle text-small ms-1">Add Product Enquiry</span>
          </Col>
          {/* Title End */}
        </Row>
      </div>
