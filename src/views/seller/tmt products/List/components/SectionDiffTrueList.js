...
import { Row, Col, Button, Form, Card, Tooltip, OverlayTrigger } from 'react-bootstrap';
import { NavLink } from 'react-router-dom';
import CsLineIcons from 'cs-line-icons/CsLineIcons';

function SectionDiffTrueList({ data, updatePrice, setdeleteproductID, setdeletemodalView, liveThisProduct }) {
  return (
    <>
      {/* List Header Start */}
        ...
        <Col>
          <Row className="g-0 h-100 align-content-center custom-sort ps-5 pe-4 h-100">
            ...
            <Col xs="2" lg="3" className="d-flex flex-column pe-1 justify-content-center">
              <div className="text-dark cursor-pointer sort">12 MM Price</div>
            </Col>
            <Col xs="2" lg="2" className="d-flex flex-column pe-1 justify-content-center">
      ...
      {data &&
        data
          ...
          .reverse()
          .map((product) => {
            const variantPriceObject = product.tmtseriesvariant?.find((item) => item.tmtserieslocation[0].sectionDiff === 0);
            const priceofVariant = variantPriceObject?.tmtserieslocation[0].price;
                    ...
                    <Row className="g-0 h-100 align-content-center">
                      ...
                      {priceofVariant && (
                        <Col xs="6" lg="3" className="d-flex flex-column justify-content-center mb-2 mb-lg-0 order-4">
                          <div>
                            <OverlayTrigger placement="top" overlay={<Tooltip id="tooltip-top">12 MM Price </Tooltip>}>
                              <div className="d-inline-block me-2">
                                <div className="lh-1 text-dark">{priceofVariant}</div>
                              </div>
                            </OverlayTrigger>
                      ...
                      <Col xs="6" lg="2" className="d-flex flex-column justify-content-center mb-2 mb-lg-0 order-4">
                        {/* <div className="text-muted text-darkmb-1">Action</div> */}
                        <div>
...
export default SectionDiffTrueList;
