        ...
        <Row className="g-0">
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/seller/product/list">
              <span className="text-dark ms-1">Individual Product List</span>
            </NavLink>
            <span className="p-2"> / </span>
            <span className="text-dark ms-1">Add Individual Product</span>
          </Col>
        </Row>
      </div>
            ...
            <Card className="border">
              ...
              <Form className="px-4 ps-4 p-2">
                ...
                <Row>
                  ...
                  <div className="mb-3 col-md-6">
                    <Form.Label className="fw-bold text-dark">
                      Product Search Tags<span className="text-danger"> * </span>
                    </Form.Label>
                    <Form.Control
                      type="text"
                      name="searchName"
                ...
                <div className="mb-3">
                  ...
                  <ReactQuill modules={modules} theme="snow" value={formData.description} onChange={handleDescriptionChange} />
