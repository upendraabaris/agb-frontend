...
function ListSeriesProduct({ history }) {
  const title = 'Multiple Seller Products';
  const description = 'Multiple Seller Products List';
  ...
  const [UpdateSeriesProduct] = useMutation(UPDATE_SERIES_PRODUCT, {
    onCompleted: () => {
      toast.success('Active status changed succesfully!');
    },
    onError: (err) => {
        ...
        <Col>
          <Row className="g-0 h-100 align-content-center custom-sort ps-5 pe-4 h-100">
            ...
            <Col xs="2" lg="3" className="d-flex flex-column pe-1 justify-content-center">
              <div className="text-dark cursor-pointer sort" onClick={() => handleSort('brand_name')}>
                Brand
              </div>
            </Col>
            <Col xs="2" lg="3" className="d-flex flex-column pe-1 justify-content-center">
            ...
            <Col xs="2" lg="3" className="d-flex flex-column pe-1 justify-content-center">
              <div className="text-dark cursor-pointer sort" onClick={() => handleSort('approve')}>
                Status
              </div>
            </Col>
          </Row>
                      ...
                      <div>
                        <OverlayTrigger placement="top" overlay={<Tooltip id="tooltip-top">Add</Tooltip>}>
                          <div className="d-inline-block me-2">
                            <NavLink className="btn-icon btn-icon-only shadow" to={`/seller/product/multiplevariantlist/${product.id}`}>
