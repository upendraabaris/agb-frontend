...
function DetailSeller() {
  const title = 'Seller Associate Profile';
  ...
  const handleSave = async () => {
    ...
    // UPI ID optional, remove comment below if you want it mandatory
    ...
    // Call the mutation if all fields are valid
    try {
      await editSeller({
        variables: {
          updateSellerId: id,
  ...
  const handleSubmit = async () => {
    const newErrors = {};
    if (!company.trim()) newErrors.company = 'Seller Associate Name is required.';
    ...
    if (!desc.trim()) newErrors.desc = 'Seller Associate Description is required.';
      ...
      {data && (
        <>
          ...
          <nav className="breadcrumb bg-transparent p-0 m-0">
            ...
            <NavLink to="/seller/profile" className="text-decoration-none text-dark breadcrumb-item">
              Dashboard
            </NavLink>
            <span className="mx-2 text-muted">/</span>
          ...
          <Row className="m-0 mt-2 mb-3 p-1 rounded bg-white align-items-center">
            <Col md="6">
              <span className="fw-bold fs-5 ps-2 pt-2">{title}</span>
            </Col>
            <Col md="6" className="text-end">
              <NavLink className="pb-1 d-inline-block hidden breadcrumb-back" to="/seller/review/sellerReview">
                <span className="text-primary ms-1">Reviews</span>
              </NavLink>
            </Col>
          </Row>
          <Row>
              ...
              <Card className="mb-2 pb-4">
                <Card.Body className="mb-n5 p-3">
                  ...
                  <div className="mb-3 ">
                    ...
                    <div className="mb-1">
                      <div>
                        <strong>User Name: </strong> {data.getSeller.user.firstName || 'N/A'} {data.getSeller.user.lastName || ''}
                      </div>
                    </div>
                    <div className="mb-1">
                      <div>
                    ...
                    <div className="mb-1">
                      <div>
                        <strong>Seller Associate Rating:</strong>{' '}
            ...
            <Col xl="8">
              <Card className="mb-1 shadow-sm">
                <Card.Body className="p-4">
                  <h4 className="mb-3 fw-bold text-dark">Seller Associate Information</h4>
                  <Row className="gy-3">
                    <Col md={6}>
                      <strong>Seller Associate Name:</strong>
                    ...
                    <Col md={12}>
                      <strong>Seller Associate Description:</strong>
                  ...
                  <div className="row">
                    <div className="mb-2 col-md-6 col-12">
                      <Form.Label className="fw-bold text-dark">
                        Seller Associate Name <span className="text-danger"> *</span>
                      </Form.Label>
                      <Form.Control
                        type="text"
                        readOnly
                        ...
                        isInvalid={!!errors.company} // ✅ show error state
                      />
                    ...
                    <div className="mb-2 col-md-6 col-12">
                      ...
                      <Form.Control
                        ...
                        isInvalid={!!errors.phone} // ✅ bind error
                      />
                    ...
                    <div className="mb-2 col-md-6 col-12">
                      ...
                      <Form.Control
                        ...
                        isInvalid={!!errors.gst} // ✅ bind error
                      />
                    ...
                    <div className="mb-2 col-md-6 col-12">
                      ...
                      <Form.Control
                        ...
                        isInvalid={!!errors.address} // ✅ show error
                      />
                    ...
                    <div className="mb-2 col-md-6 col-12">
                      ...
                      <Form.Control
                        ...
                        isInvalid={!!errors.city} // ✅ show error
                      />
                    ...
                    <div className="mb-2 col-md-6 col-12">
                      ...
                      <Form.Control
                        ...
                        isInvalid={!!errors.pincode} // ✅ bind error
                      />
                    ...
                    <div className="mb-2 col-md-6 col-12">
                      ...
                      <Form.Select
                        ...
                        isInvalid={!!errors.state} // ✅ show error
                      >
                    ...
                    <div className="mb-2">
                      <Form.Label className="fw-bold text-dark">
                        Seller Associate Description <span className="text-danger"> *</span>
                      </Form.Label>
                      <Form.Control
                        type="text"
                        as="textarea"
                        ...
                        isInvalid={!!errors.desc} // ✅ show error
                      />
