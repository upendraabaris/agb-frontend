        ...
        <Card>
          <div>
            <Form onSubmit={handleSubmit}>
                      ...
                      <table className="table m-0">
                        {supervariant.superlocation.map((location, locationIndex) => (
                          <tbody key={locationIndex}>
                            <tr>
                              <td colSpan={7}>
                                <h5 className="text-white rounded bg-info p-2 mb-0 small">Add Locations {locationIndex + 1}</h5>
                              </td>
                            </tr>
                            <tr>
                              <td colSpan={7}>
                                <div className="p-2 border rounded">
                                  <Form.Group className="mb-1 mt-2">
                                    <Form.Check
                                      type="radio"
                                      id={`manual-pincode-${variantIndex}-${locationIndex}`}
                                      label={
                                        <span className="fw-bold text-dark">
                                          Manually Enter Delivery Pincodes: <small>Paste Pincode with Comma (Example: 313001, 413001)</small>
                                        </span>
                                      }
                                      ...
                                      onChange={() => {
                                        ...
                                        setSelectedStates([]);
                                        setSelectedCities([]);
                                        handleLocationChange({ target: { name: 'pincode', value: '' } }, variantIndex, locationIndex);
                                      }}
                                    />
                                    <Form.Control
                                      name="pincode"
                                      ...
                                      disabled={deliveryType !== 'manual'}
                                    />
                                  </Form.Group>
                                  <Form.Group className="mb-1 mt-3">
                                    <Form.Check
                                      type="radio"
                                      id={`select-state-${variantIndex}-${locationIndex}`}
                                      label={<span className="fw-bold text-dark">Select State(s)</span>}
                                    ...
                                    <Select
                                      isMulti
                                      options={stateData?.getAllStates.map((st) => ({ value: st.pincode, label: st.state }))}
              ...
              <div className="d-flex p-2 ms-3 justify-content-between">
