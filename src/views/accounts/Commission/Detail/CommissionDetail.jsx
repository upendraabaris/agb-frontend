...
function Commission() {
  const { id } = useParams();
  const title = 'Associate Commission';
  const description = 'Associate Commission';
      ...
      <div className="page-title-container">
        <Row className="g-0">
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/accounts/commission/list">
              <span className="align-middle text-dark ms-1">Back</span>
            </NavLink>
