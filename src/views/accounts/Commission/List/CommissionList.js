  ...
  return (
    <>
      ...
      <div className="page-title-container mb-2">
        <Row className="g-0">
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            ...
            <span className="align-middle text-dark ms-1">Associate List</span>
          </Col>
        </Row>
      </div>
      ...
      <Row className="m-0 mb-2 p-1 rounded bg-white align-items-center">
        <Col md="6">
          <span className="fw-bold fs-5 ps-2 pt-2">Associate List</span>
          <span className="small ps-2">{data && data.getAllSellers ? `(${data.getAllSellers.length})` : ''}</span>
        </Col>
                ...
                {data?.getAllSellers?.length > 0 ? (
                  data.getAllSellers.map((seller) => (
                    <tr key={seller.id}>
                      ...
                      <td>
                        <NavLink to={`/accounts/commission/detail/${seller.id}/commission`} className="btn btn-outline-primary btn-sm">
                          Commission
                        </NavLink>
                      </td>
                    </tr>
