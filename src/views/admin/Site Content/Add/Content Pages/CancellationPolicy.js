...
function CancellationPolicy({data, theme, modules, eventKey, refetch}) {
  ...
  return (<>
    <h2 className="small-title my-2 py-2">Cancellation Policy</h2>
    <div className="mb-3 filled form-group tooltip-end-top">
      <ReactQuill modules={modules} theme="snow" placeholder="Write Cancellation Policies here" value={mainContent} onChange={setMainContent} name="content" />
    </div>
