...
function RegisterPageContent({data, theme, modules, eventKey, refetch}) {
  ...
  return (<>
    <h2 className="small-title my-2 py-2">Register Page Content</h2>
    <div className="mb-3 filled form-group tooltip-end-top">
      <ReactQuill modules={modules} theme="snow" placeholder="Write Here" value={mainContent} onChange={setMainContent} name="content" />
    </div>
