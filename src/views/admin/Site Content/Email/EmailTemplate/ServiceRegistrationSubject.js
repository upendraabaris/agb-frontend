...
function ServiceRegistrationSubject() {
  const title = 'Service Associate Request Subject (Customer, Portal Admin)';
  const description = 'Service Associate Request Subject (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'serviceregistrationsubject';
...
export default ServiceRegistrationSubject;
