...
function OrderSuccessSeller() {
  const title = 'Online order success after account confirmation (Seller Admin)';
  const description = 'Online order success after account confirmation (Seller Admin)';  
  const history = useHistory();
  const eventKey = 'orderSuccess';
...
export default OrderSuccessSeller;
