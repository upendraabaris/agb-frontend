...
function EnquiryRequestApprove() {
  const title = 'Enquiry associate approve (Customer, Portal Admin)';
  const description = 'Enquiry associate approve (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'enquiryRequestApprove';
...
export default EnquiryRequestApprove;
