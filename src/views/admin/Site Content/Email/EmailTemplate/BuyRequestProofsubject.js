...
function BuyRequestProofsubject() {
  const title = 'DMT payment received success subject (Customer, Account Admin)';
  const description = 'DMT payment received success subject (Customer, Account Admin)';
  const history = useHistory();
  const eventKey = 'buyRequestProofsubject';
  ...
  return (
    <>
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className="pt-2 fw-bold small">
            (First Name: $firstname, Mobile No.: $mobile, Email: $email, Order Tracking Link: $orderlink, Order Id: $orderid, Payment
            Mode: $paymentmode, Payment ID: $paymentid, Order Amount: $amount, Website Name: $website)
          </div>
        </Row>
      </div>
      ...
      <Form.Control
          ...
          placeholder="DMT payment received success Subject"
        />
...
export default BuyRequestProofsubject;
