...
function BusinessRegistrationSubject() {
  const title = 'Business Associate Request Subject (Customer, Portal Admin)';
  const description = 'Business Associate Request Subject (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'businessregistrationsubject';
...
export default BusinessRegistrationSubject;
