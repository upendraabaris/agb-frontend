...
function OrderCancelsubjectSubject() {
  const title = 'Order cancel seller mail (Seller)';
  const description = 'Order cancel seller mail (Seller)';
  const history = useHistory();
  const eventKey = 'orderCancelSellersubject';
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className="pt-2 fw-bold small">
            (First Name: $firstname, Mobile: $mobile, Order Id: $orderid, Order Date: $orderdate, Cancel Date: $canceldate, Reason: $reason,
            Website: $website, Seller Link: $orderlinkseller)
          </div>
        </Row>
      </div>
...
export default OrderCancelsubjectSubject;
