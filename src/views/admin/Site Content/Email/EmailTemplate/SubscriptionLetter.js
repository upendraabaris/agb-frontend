...
function SubscriptionLetter() {
  const title = 'Subscription Newsletter (Customer, Portal Admin)';
  const description = 'Subscription Newsletter (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'subscriptionLetter';
    ...
    <div className="page-title-container">
      <Row className="g-0">
        ...
        <div className='pt-2 fw-bold small'>
          (Email : $email, Website Name: $website)
        </div>
      </Row>
    </div>
