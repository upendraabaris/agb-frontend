...
function ShoppingCartEnquiryPage() {
  const title = 'Shopping cart enquiry (Customer, Portal Admin)';
  const description = 'Shopping cart enquiry (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'shoppingCartEnquiryPage';
    ...
    <div className="page-title-container">
      <Row className="g-0">
        ...
        <div className='pt-2 fw-bold small'>
          ( Product Name: $firstname, Email: $email, Mobile No.: $mobile, Message: $message, Cart Details: $cartDetails, Website Name: $website)
        </div>
      </Row>
    </div>
...
export default ShoppingCartEnquiryPage;
