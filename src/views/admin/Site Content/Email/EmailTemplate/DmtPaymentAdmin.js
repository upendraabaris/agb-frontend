...
function DmtPaymentAdmin() {
  const title = 'DMT payment proof submit  (Customer, Portal Admin, Account Admin)';
  const description = 'DMT payment proof submit  (Customer, Portal Admin, Account Admin)';  
  const history = useHistory();
  const eventKey = 'dmtPaymentAdmin';
...
export default DmtPaymentAdmin;
