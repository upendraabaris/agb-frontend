...
function DealerRegistrationAlready() {
  const title = 'Dealer Associate Request (Customer, Portal Admin)';
  const description = 'Dealer Associate Request (Customer, Portal Admin';
  const eventKey = 'businessDealerRegistrationMail';
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className="pt-2 fw-bold small">
            (BA Name: $baName, Dealer Name: $dealerName, Dealer GST: $dealergst, Dealer Address: $dealeraddress, Dealer City: $dealercity, Dealer State:
            $dealerstate, Dealer Pincode: $dealerpincode, Dealer Description: $dealerdescription, Dealer Mobile No: $dealerMobileNo, Dealer Email: $dealeremail,
