...
function EnquiryRequestApproveSubject() {
  const title = 'Enquiry Associate Approve Subject (Customer, Portal Admin)';
  const description = 'Enquiry Associate Approve Subject (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'enquiryrequestapprovesubject';
...
export default EnquiryRequestApproveSubject;
