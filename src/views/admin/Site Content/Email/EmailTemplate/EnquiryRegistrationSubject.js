...
function EnquiryRegistrationSubject() {
  const title = 'Enquiry Associate Request Subject (Customer, Portal Admin)';
  const description = 'Enquiry Associate Request Subject (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'enquiryregistrationsubject';
...
export default EnquiryRegistrationSubject;
