...
function ServiceRegistration() {
  const title = 'Service Associate Request (Customer, Portal Admin)';
  const description = 'Service Associate Request (Customer, Portal Admin';  
  const history = useHistory();
  const eventKey = 'serviceRegistrationMail';
