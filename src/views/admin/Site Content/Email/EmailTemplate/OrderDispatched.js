...
function OrderDispatched() {
  const title = 'Order dispatched  (Customer, Portal Admin, Seller Admin)';
  const description = 'Order dispatched  (Customer, Portal Admin, Seller Admin)';  
  const history = useHistory();
  const eventKey = 'orderDispatched';
