...
function OrderDelivery() {
  const title = 'Order delivery (Customer, Portal Admin, Seller Admin)';
  const description = 'Order delivery (Customer, Portal Admin, Seller Admin)';  
  const history = useHistory();
  const eventKey = 'orderDelivery';
