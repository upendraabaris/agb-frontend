...
function BuyRequestReceipt() {
  const title = 'DMT payment received success (Seller Admin)';
  const description = 'DMT payment received success (Seller Admin)';
  const history = useHistory();
  const eventKey = 'buyRequestReceipt';
...
export default BuyRequestReceipt;
