...
function ShoppingCartSubjectEnquiryPage() {
  const title = 'Shopping cart subject enquiry (Customer, Portal Admin)';
  const description = 'Shopping cart subject enquiry (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'shoppingCartSubjectEnquiryPage';
...
export default ShoppingCartSubjectEnquiryPage;
