...
function DealerRegistrationAlreadySubject() {
  const title = 'Register New Dealer Associate Subject (Customer, Portal Admin)';
  const description = 'Register New Dealer Associate Subject (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'newDealerRegistrationSubject';
    ...
    <>
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className="pt-2 fw-bold small">(Company Name : $customerName, Website Name: $website)</div>
        </Row>
      </div>
      <div className="mb-3 filled form-group tooltip-end-top">
        <Form.Control className="p-2 border" type="text" value={mainContent} onChange={(e) => setMainContent(e.target.value)} placeholder="Enter subject" />
      </div>
...
export default DealerRegistrationAlreadySubject;
