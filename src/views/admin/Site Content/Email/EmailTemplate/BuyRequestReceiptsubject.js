...
function BuyRequestReceiptsubject() {
  const title = 'DMT payment received success subject (Seller Admin)';
  const description = 'DMT payment received success subject (Seller Admin)';
  const history = useHistory();
  const eventKey = 'buyRequestReceiptsubject';
    ...
    <>
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className="pt-2 fw-bold small">
            (First Name: $firstname, Mobile No.: $mobile, Email: $email, Order Tracking Link: $orderlink, Order Id: $orderid, Shipping
            Address 1: $address1, Shipping Address 2: $address2, City: $city, State: $state, Pincode: $pincode, Company Name: $company, Website Name: $website)
          </div>
        </Row>
      </div>
      <div className="mb-3 filled form-group tooltip-end-top">
        <Form.Control
          ...
          placeholder="DMT payment received success subject (Seller Admin)"
        />
...
export default BuyRequestReceiptsubject;
