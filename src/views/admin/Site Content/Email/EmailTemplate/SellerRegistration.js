...
function SellerRegistration() {
  const title = 'Seller registration (Customer, Portal Admin)';
  const description = 'Seller registration (Customer, Portal Admin';
  const history = useHistory();
  const eventKey = 'sellerRegistrationMail';
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className="pt-2 fw-bold small">
            (Customer Name: $customername, Company Name: $firmname, Company Email: $firmemail, GST/Pancard No.: $gst_pan, Mobile No.: $firmmobile, Company
