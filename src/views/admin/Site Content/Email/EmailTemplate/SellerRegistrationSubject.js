...
function SellerRegistrationSubject() {
  const title = 'Seller Registration Subject (Customer, Portal Admin)';
  const description = 'Seller Registration Subject (Customer, Portal Admin)';  
  const history = useHistory();
  const eventKey = 'sellerregistrationsubject';
  ...
  return (<>
    <HtmlHead title={title} description={description} />
      ...
      <Row className="g-0">
          ...
          (Company Name : $companyname, Company Email: $email, GST No.: $gst, Mobile No.: $mobile, Company Description : $description, Address 1: $address1, Address 2: $address2, City: $city, State: $state, Pincode: $pincode, Website Name: $website)<br />
          (Customer First Name: $customerfirstname, Customer Last Name: $customerlastname, Customer Email: $customeremail, Customer Mobile No.: $customermobile)
          </div>
        </Row>
      </div>
...
export default SellerRegistrationSubject;
