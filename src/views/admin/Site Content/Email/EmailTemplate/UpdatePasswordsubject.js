...
function UpdatePasswordsubject() {
  const title = 'Forgot password subject success (Customer)';
  const description = 'Forgot password subject success (Customer)';
  const history = useHistory();
  const eventKey = 'updatePasswordsubject';
  ...
  return (<>
    ...
    <div className="page-title-container">
      <Row className="g-0">
        ...
        <Col className="col-auto mb-3 mb-sm-0 me-auto">
          ...
          <h1 className="mb-0 pb-0 fw-bold display-4" id="title">Forgot Password Success (Customer)</h1>
        </Col>
        {/* Title End */}
        <div className='pt-2 fw-bold small'>
          (First Name: $firstname, Last Name: $lastname, Mobile No.: $mobile, Email: $email, Website Name: $website)
        </div>
      </Row>
    </div>
    <div className="mb-3 filled form-group tooltip-end-top">
      <Form.Control
        ...
        placeholder="Update Password Subject"
      />
...
export default UpdatePasswordsubject;
