...
function SellerRequestApprove() {
  const title = 'Seller request approve (Customer, Portal Admin)';
  const description = 'Seller request approve (Customer, Portal Admin)';  
  const history = useHistory();
  const eventKey = 'sellerRequestApprove';
...
export default SellerRequestApprove;
