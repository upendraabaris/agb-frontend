...
function CustomerRegistrationsubject() {
  const title = 'Customer Registration Subject (Customer)';
  const description = 'Customer registration subject (Customer)';  
  const history = useHistory();
  const eventKey = 'customerRegistrationsubject';
    ...
    <div className="page-title-container">
      <Row className="g-0">      
        ...
        <div className='pt-2 fw-bold small'>
            (First Name: $firstname, Last Name: $lastname, Email: $email, Mobile No.: $mobile, Website Name: $website)
        </div>
      </Row>
    </div>
...
export default CustomerRegistrationsubject;
