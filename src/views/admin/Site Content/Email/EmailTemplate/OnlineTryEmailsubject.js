...
function OnlineTryEmailsubject() {
  const title = 'Try payment method online subject (Customer, Portal Admin)';
  const description = 'Try payment method online subject (Customer, Portal Admin)';  
  const history = useHistory();
  const eventKey = 'onlineTryEmailsubject';
  ...
  return (<>
    <HtmlHead title={title} description={description} />
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className='pt-2 fw-bold small'>
            (First Name: $firstname, Last Name: $lastname, Mobile No.: $mobile, Address1: $address1, Address2: $address2, City: $city, State: $state, Pincode: $pincode, Buy Interest No.: $orderid, Total amount: Rs. $amount, Order Link: $orderlink,  Website Name: $website)
          </div>
        </Row>
      </div>
      ...
      <Form.Control
          ...
          placeholder="Online Try Subject"
        />
...
export default OnlineTryEmailsubject;
