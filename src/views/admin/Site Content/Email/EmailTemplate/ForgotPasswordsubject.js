...
function ForgotPasswordsubject() {
  const title = 'Forgot password request (Customer)';
  const description = 'Forgot password request (Customer)';  
  const history = useHistory();
  const eventKey = 'forgotPasswordsubject';
  ...
  return (<>
    <HtmlHead title={title} description={description} />
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className='pt-2 fw-bold small'>
            (First Name: $firstname, Forgot Password Link: $link, Website Name: $website)
          </div>
        </Row>
      </div>
      ...
      <Form.Control
          ...
          placeholder="Forgot Password Subject"
        />
