...
function ProductClasssubject() {
  const title = 'Product Class Subject (Portal Admin, Seller Admin)';
  const description = 'Product Class Subject (Portal Admin, Seller Admin)';
  const history = useHistory();
  const eventKey = 'productClassSubject';
  ...
  return (<>
    ...
    <div className="page-title-container">
      <Row className="g-0">
        ...
        <div className='pt-2 fw-bold small'>
          (Company Name : $companyname, Mobile No.: $mobile, Email: $email, Product Class Name: $className, Product Commission Value: $productCommission, Product Commission Type: $productType,  Listing Commission Value: $listingCommission, Listing Commission Type: $listingType, Fixed Commission Value: $fixedCommission, Fixed Commission Type: $fixedType, Shipping Fee Value: $shippingCommission, Shipping Fee Type: $shippingType, Website Name: $website)
        </div>
      </Row>
    </div>
    <div className="mb-3 filled form-group tooltip-end-top">
      <Form.Control
        ...
        placeholder="Product class subject (Seller Admin, Portal Admin)"
      />
...
export default ProductClasssubject;
