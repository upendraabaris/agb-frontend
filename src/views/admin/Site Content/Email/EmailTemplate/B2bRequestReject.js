...
function B2bRequestReject() {
  const title = 'B2B Request Reject (Customer, Portal Admin)';
  const description = 'B2B Request Reject (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'b2bRequestReject';
    ...
    <div className="page-title-container">
      <Row className="g-0">
        ...
        <div className='pt-2 fw-bold small'>
          (First Name : $firstname, Reason for Rejection: $reason, Website Name: $website)
        </div>
      </Row>
    </div>
...
export default B2bRequestReject;
