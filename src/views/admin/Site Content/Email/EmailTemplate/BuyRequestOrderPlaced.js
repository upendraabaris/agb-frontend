...
function BuyRequestOrderPlaced() {
  const title = 'Bulk enquiry - product details pages (Portal Admin)';
  const description = 'Bulk enquiry - product details pages (Portal Admin)';
  const history = useHistory();
  const eventKey = 'orderPlaced';
...
export default BuyRequestOrderPlaced;
