...
function DealerRegistrationAlreadySubject() {
  const title = 'Dealer Associate Request Subject (Customer, Portal Admin)';
  const description = 'Dealer Associate Request Subject (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'businessDealerRegistrationSubject';
