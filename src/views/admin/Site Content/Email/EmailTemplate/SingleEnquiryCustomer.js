...
function SingleEnquiryCustomer() {
  const title = 'Single Enquiry - Product Details Pages (Customer, Portal Admin)';
  const description = 'Single Enquiry - Product Details Pages (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'singleEnquiryCustomer';
...
export default SingleEnquiryCustomer;
