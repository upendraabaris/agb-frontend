...
function OrderCancelSeller() {
  const title = 'Order Cancel (Seller Admin)';
  const description = 'Order Cancel (Seller Admin)';
  const history = useHistory();
  const eventKey = 'orderCancelSeller';
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className="pt-2 fw-bold small">
            (First Name: $firstname, Mobile: $mobile, Order Id: $orderid, Order Date: $orderdate, Cancel Date: $canceldate, Reason: $reason, Website: $website,
            Seller Link: $orderlinkseller)
          </div>
        </Row>
      </div>
