...
function BusinessRequestApprove() {
  const title = 'Business associate approve (Customer, Portal Admin)';
  const description = 'Business associate approve (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'businessRequestApprove';
...
export default BusinessRequestApprove;
