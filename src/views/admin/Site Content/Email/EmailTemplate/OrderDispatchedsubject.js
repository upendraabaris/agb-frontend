...
function OrderDispatchedsubject() {
  const title = 'Order dispatched subject (Customer, Portal Admin, Seller Admin)';
  const description = 'Order dispatched subject (Customer, Portal Admin, Seller Admin)';  
  const history = useHistory();
  const eventKey = 'orderDispatchedsubject';
    ...
    <HtmlHead title={title} description={description} />
      ...
      <Row className="g-0">
          ...
          <div className='pt-2 fw-bold small'>
            (First Name: $firstname, Last Name: $lastname, Mobile No.: $mobile, Email: $email,  Order Tracking Link: $orderlink, Order Id: $orderid, Shipped By: $shippedby, Tracking No.: $trackingno, Tracking URL: $trackingurl, Shipped Date: $shippeddate, Company Name: $seller, Delivery Date: $delivereddate, Website Name: $website)
          </div>
        </Row>
      </div>
      ...
      <Form.Control
          ...
          placeholder="Order dispatched subject"
        />
...
export default OrderDispatchedsubject;
