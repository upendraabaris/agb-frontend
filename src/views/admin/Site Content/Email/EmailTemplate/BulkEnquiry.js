...
function BulkEnquiry() {
  const title = 'Bulk Enquiry - Product Details Pages (Seller Admin)';
  const description = 'Bulk Enquiry - Product Details Pages (Seller Admin)';
  const history = useHistory();
  const eventKey = 'bulkEnquiry';
