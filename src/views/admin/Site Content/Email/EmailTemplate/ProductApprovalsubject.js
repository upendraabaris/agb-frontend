...
function ProductApprovalsubject() {
  const title = 'Product approval subject (Seller Admin, Portal Admin)';
  const description = 'Product approval subject (Seller Admin, Portal Admin)';
  const history = useHistory();
  const eventKey = 'ProductApprovalsubject';
    ...
    <>
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          {/* Title End */}
          <div className="pt-2 small">( Product Link : $productlink, Product Name: $productname, Company Name: $seller, Website Name: $website)</div>
        </Row>
      </div>
      ...
      <Form.Control
          ...
          placeholder="Product approval subject (Seller Admin, Portal Admin) "
        />
...
export default ProductApprovalsubject;
