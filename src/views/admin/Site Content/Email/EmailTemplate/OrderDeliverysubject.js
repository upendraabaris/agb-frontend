...
function OrderDeliverysubject() {
  const title = 'Order delivery subject (Customer, Portal Admin, Seller Admin)';
  const description = 'Order delivery subject (Customer, Portal Admin, Seller Admin)';  
  const history = useHistory();
  const eventKey = 'orderDeliverysubject';
  ...
  return (<>
    <HtmlHead title={title} description={description} />
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className='pt-2 fw-bold small'>
            (First Name: $firstname, Last Name: $lastname, Mobile No.: $mobile, Email: $email,  Order Tracking Link: $orderlink, Order Id: $orderid, Company Name: $seller, Delivery Date: $delivereddate, Website Name: $website)
          </div>
        </Row>
      </div>
      ...
      <Form.Control
          ...
          placeholder="Order delivery subject"
        />
...
export default OrderDeliverysubject;
