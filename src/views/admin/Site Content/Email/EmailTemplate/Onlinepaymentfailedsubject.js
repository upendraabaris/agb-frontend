...
function Onlinepaymentfailedsubject() {
  const title = 'Online payment failed subject (Portal Admin, Customer)';
  const description = 'Online payment failed subject (Portal Admin, Customer)';
  const history = useHistory();
  const eventKey = 'Onlinepaymentfailedsubject';
...
export default Onlinepaymentfailedsubject;
