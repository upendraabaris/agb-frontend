...
function BulkEnquirySubjectCustomer() {
  const title = 'Bulk Enquiry Subject - Product Details Pages (Customer, Portal Admin)';
  const description = 'Bulk Enquiry Subject - Product Details Pages (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'bulkEnquirySubjectCustomer';
...
export default BulkEnquirySubjectCustomer;
