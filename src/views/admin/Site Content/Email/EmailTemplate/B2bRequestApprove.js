...
function B2bRequestApprove() {
  const title = 'B2B Request Approve (Customer, Portal Admin)';
  const description = 'B2B Request Approve (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'b2bRequestApprove';
    ...
    <div className="page-title-container">
      <Row className="g-0">
        ...
        <div className='pt-2 fw-bold small'>
          (First Name: $firstname, Business Name : $name, Website Name: $website)
        </div>
      </Row>
    </div>
...
export default B2bRequestApprove;
