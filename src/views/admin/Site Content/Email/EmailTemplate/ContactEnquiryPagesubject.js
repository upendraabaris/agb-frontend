...
function ContactEnquiryPagesubject() {
  const title = 'Contact us enquiry subject (Customer, Portal Admin)';
  const description = 'Contact us enquiry subject (Customer, Portal Admin';  
  const history = useHistory();
  const eventKey = 'contactEnquiryPagesubject';
  ...
  return (<>
    <HtmlHead title={title} description={description} />
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className='pt-2 fw-bold small'>
            (First Name: $firstname, Email: $email, Mobile No.: $mobile, Address: $address, State: $state, Enquiry Message: $message, Website Name: $website)
          </div>
        </Row>
      </div>
      ...
      <Form.Control
          ...
          placeholder="Contact Us Enquiry Subject"
        />
...
export default ContactEnquiryPagesubject;
