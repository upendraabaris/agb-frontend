...
function BuyRequestFailure() {
  const title = 'Order payment failure (Customer, Portal Admin, Account Admin)';
  const description = 'Order payment failure (Customer, Portal Admin, Account Admin)';
  const history = useHistory();
  const eventKey = 'buyRequestFailure';
...
export default BuyRequestFailure;
