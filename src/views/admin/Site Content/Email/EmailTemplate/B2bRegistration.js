...
function B2bRegistration() {
  const title = 'B2B Registration (Customer, Portal admin)';
  const description = 'B2B Registration (Customer, Portal admin)';
  const history = useHistory();
  const eventKey = 'b2bRegistration';
    ...
    <div className="page-title-container">
      <Row className="g-0">
        ...
        <div className='pt-2 fw-bold small'>
          (First Name: $firstname, Business Name : $name, Business Email: $email, GST No.: $gst, Mobile No.: $mobile, Business Description : $description, Address1: $address, Address2: $address2, City: $city, State: $state, Pincode: $pincode, Website Name: $website)
        </div>
      </Row>
    </div>
