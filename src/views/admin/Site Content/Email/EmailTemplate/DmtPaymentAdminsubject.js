...
function DmtPaymentAdminsubject() {
  const title = 'DMT payment proof submit subject (Customer, Portal Admin, Account Admin)';
  const description = 'DMT payment proof submit subject (Customer, Portal Admin, Account Admin)';  
  const history = useHistory();
  const eventKey = 'dmtPaymentAdminsubject';
    ...
    <HtmlHead title={title} description={description} />
      ...
      <Row className="g-0">
          ...
          <div className='pt-2 fw-bold small'>
            (First Name: $firstname, Last Name: $lastname, Mobile No.: $mobile, Email: $email, Order Tracking Link: $orderlink, Order Id: $orderid, Payment Mode: $paymentmode, Payment ID: $paymentid, Order Amount: $amount, Website Name: $website)
          </div>
        </Row>
      </div>
      ...
      <Form.Control
          ...
          placeholder="Dmt Payment Admin Subject"
        />
...
export default DmtPaymentAdminsubject;
