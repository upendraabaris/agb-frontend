...
function BusinessDealerRequestApprove() {
  const title = 'Dealer Associate Approve (Customer, Portal Admin)';
  const description = 'Dealer Associate Approve (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'businessDealerRequestApprove';
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className="pt-2 fw-bold small">
            ( BA Name: $baName, Dealer Name: $dealerName, GSTIN: $dealergst, Address: $dealeraddress, City: $dealercity, State: $dealerstate, Pincode:
            $dealerpincode, Description: $dealerdescription, Mobile No: $dealerMobileNo, Email: $dealeremail, Website Name: $website )
          </div>
        </Row>
      </div>
...
export default BusinessDealerRequestApprove;
