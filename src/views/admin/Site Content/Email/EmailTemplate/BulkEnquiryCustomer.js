...
function BulkEnquiryCustomer() {
  const title = 'Bulk Enquiry - Product Details Pages (Customer, Portal Admin)';
  const description = 'Bulk Enquiry - Product Details Pages (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'bulkEnquiryCustomer';
...
export default BulkEnquiryCustomer;
