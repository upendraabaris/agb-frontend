...
function OrderCancel() {
  const title = 'Order cancel by customer making payment (Customer, Portal Admin)';
  const description = 'Order cancel by customer making payment (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'orderCancel';
