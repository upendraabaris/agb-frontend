...
function OnlineOrderSuccess() {
  const title = 'Online order success (Customer, Portal Admin, Account Admin)';
  const description = 'Online order success (Customer, Portal Admin, Account Admin)';
  const history = useHistory();
  const eventKey = 'onlineOrderSuccess';
