...
function ServiceRequestApproveSubject() {
  const title = 'Service Associate Approve Subject (Customer, Portal Admin)';
  const description = 'Service Associate Approve Subject (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'servicerequestapprovesubject';
...
export default ServiceRequestApproveSubject;
