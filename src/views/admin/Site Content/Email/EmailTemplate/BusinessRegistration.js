...
function BusinessRegistration() {
  const title = 'Business Associate Request (Customer, Portal Admin)';
  const description = 'Business Associate Request (Customer, Portal Admin';
  const history = useHistory();
  const eventKey = 'businessRegistrationMail';
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className="pt-2 fw-bold small">
            (Customer Name: $customername, Company Name: $firmname, Company Email: $firmemail, GST No.: $gst, Mobile No.: $firmmobile, Company
            Description: $firmdescription, Company Address: $firmaddress, Customer Email: $customeremail, Customer Mobile No.: $customermobile, Website:
            $website )
          </div>
        </Row>
      </div>
