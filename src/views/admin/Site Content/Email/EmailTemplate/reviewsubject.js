...
function reviewsubject() {
  const title = 'Review subject (Portal Admin, Seller Admin, Customer)';
  const description = 'Review subject (Portal Admin, Seller Admin, Customer)';
  const history = useHistory();
  const eventKey = 'reviewsubject';
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className="pt-2 small">
            (First Name: $firstname, Last Name: $lastname, Mobile No.: $mobile, Email: $email, Product Name: $productname, Product Link: $productlink, Review Title: $reviewtitle, Review Description: $reviewdescription, Rating: $rating, Website Name: $website)
          </div>
        </Row>
      </div>
