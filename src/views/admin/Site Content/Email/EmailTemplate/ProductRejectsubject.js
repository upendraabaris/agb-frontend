...
function ProductRejectsubject() {
  const title = 'Product reject subject (Seller Admin, Portal Admin)';
  const description = 'Product reject subject (Seller Admin, Portal Admin)';  
  const history = useHistory();
  const eventKey = 'ProductRejectsubject';
    ...
    <HtmlHead title={title} description={description} />
      ...
      <Row className="g-0">
          ...
          <div className='pt-2 fw-bold small'>
            ( Product Link : $productlink, Product Name: $productname, Company Name: $seller, Reject Reason: $reason, Website Name: $website)
          </div>
        </Row>
      </div>
      ...
      <Form.Control
          ...
          placeholder="Product reject subject (Seller Admin, Portal Admin)"
        />
...
export default ProductRejectsubject;
