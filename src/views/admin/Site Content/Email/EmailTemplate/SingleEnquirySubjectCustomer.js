...
function SingleEnquirySubjectCustomer() {
  const title = 'Single Product Enquiry - Product Details Pages (Customer, Portal Admin)';
  const description = 'Single Product Enquiry - Product Details Pages (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'singleEnquirySubjectCustomer';
...
export default SingleEnquirySubjectCustomer;
