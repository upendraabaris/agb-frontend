...
function OrderPacked() {
  const title = 'Order packed (Customer, Portal Admin, Seller Admin)';
  const description = 'Order packed (Customer, Portal Admin, Seller Admin)';
  const history = useHistory();
  const eventKey = 'orderPacked';
