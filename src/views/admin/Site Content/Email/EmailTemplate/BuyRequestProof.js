...
function BuyRequestProof() {
  const title = 'DMT payment received success (Customer, Account Admin)';
  const description = 'DMT payment received success (Customer, Account Admin)';
  const history = useHistory();
  const eventKey = 'buyRequestProof';
...
export default BuyRequestProof;
