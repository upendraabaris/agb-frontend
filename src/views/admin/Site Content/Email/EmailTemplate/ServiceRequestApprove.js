...
function ServiceRequestApprove() {
  const title = 'Service associate approve (Customer, Portal Admin)';
  const description = 'Service associate approve (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'serviceRequestApprove';
...
export default ServiceRequestApprove;
