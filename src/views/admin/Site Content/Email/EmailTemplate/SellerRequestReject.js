...
function SellerRequestReject() {
  const title = 'Seller Request Reject (Customer, Portal Admin)';
  const description = 'Seller Request Reject (Customer, Portal Admin)';  
  const history = useHistory();
  const eventKey = 'sellerRequestReject';
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className='pt-2 fw-bold small'>
            (Company Name : $name, Reason for Rejection: $reason, Website Name: $website)
          </div>
        </Row>
      </div>
...
export default SellerRequestReject;
