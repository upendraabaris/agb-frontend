...
function EnquiryRegistration() {
  const title = 'Enquiry Associate Request (Customer, Portal Admin)';
  const description = 'Enquiry Associate Request (Customer, Portal Admin';  
  const history = useHistory();
  const eventKey = 'enquiryRegistrationMail';
