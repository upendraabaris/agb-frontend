...
function OnlineTryEmail() {
  const title = 'Try Payment Method Online (Customer, Portal Admin)';
  const description = 'Try Payment Method Online (Customer, Portal Admin)';  
  const history = useHistory();
  const eventKey = 'onlineTryEmail';
