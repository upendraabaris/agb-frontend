...
function OrderSuccessSellersubject() {
  const title = 'Online order success after account confirmation subject (Seller Admin)';
  const description = 'Online order success after account confirmation subject (Seller Admin)';  
  const history = useHistory();
  const eventKey = 'orderSuccesssubject';
    ...
    <HtmlHead title={title} description={description} />
      ...
      <Row className="g-0">
          ...
          <div className="pt-2 small">
            (First Name: $firstname, Last Name: $lastname, Mobile No.: $mobile, Email: $email, Address 1: $address1, Address 2: $address2, City: $city, State: $state, Pincode: $pincode,
             Seller Panel Order Tracking Link: $orderlink, Order Id: $orderid, Company Name: $company, Website Name: $website)
          </div>
        </Row>
      </div>
      ...
      <Form.Control
          ...
          placeholder="Customer Registration Subject"
        />
...
export default OrderSuccessSellersubject;
