...
function OnlineOrderSuccesssubject() {
  const title = 'Online order success subject (Customer, Portal Admin, Account Admin)';
  const description = 'Online order success subject (Customer, Portal Admin, Account Admin)';
  const history = useHistory();
  const eventKey = 'onlineOrderSuccesssubject';
  ...
  return (
    <>
      ...
      <Form.Control
          ...
          placeholder="Online Order Success Subject"
        />
...
export default OnlineOrderSuccesssubject;
