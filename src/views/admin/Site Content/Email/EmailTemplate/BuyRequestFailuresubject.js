...
function BuyRequestFailuresubject() {
  const title = 'Order payment failure subject (Customer, Portal Admin, Account Admin)';
  const description = 'Order payment failure subject (Customer, Portal Admin, Account Admin)';
  const history = useHistory();
  const eventKey = 'buyRequestFailuresubject';
  ...
  return (<>
    ...
    <div className="page-title-container">
      <Row className="g-0">
        ...
        <div className='pt-2 fw-bold small'>
          (First Name: $firstname, Last Name: $lastname, Mobile No.: $mobile, Reject Reason: $reason, Payment Mode: $paymentmode, Payment Id: $paymentid, Order Tracking Link: $orderlink, Email: $email, Order Amount: $amount, Website Name: $website)
        </div>
      </Row>
    </div>
    <div className="mb-3 filled form-group tooltip-end-top">
      <Form.Control
        ...
        placeholder="Order payment failure subject"
      />
...
export default BuyRequestFailuresubject;
