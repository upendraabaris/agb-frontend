...
function BusinessDealerRequestApproveSubject() {
  const title = 'Dealer Associate Approve Subject (Customer, Portal Admin)';
  const description = 'Dealer Associate Approve Subject (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'businessDealerRequestApproveSubject';
    ...
    <div className="page-title-container">
      <Row className="g-0">
        ...
        <div className='pt-2 fw-bold small'>
          (Company Name : $name, Website Name: $website)
        </div>
      </Row>
    </div>
...
export default BusinessDealerRequestApproveSubject;
