...
function BuyRequestsubject() {
  const title = 'Try payment method DMT subject (Customer, Portal Admin)';
  const description = 'Try payment method DMT subject (Customer, Portal Admin)';  
  const history = useHistory();
  const eventKey = 'buyRequestsubject';
  ...
  return (<>
    <HtmlHead title={title} description={description} />
      ...
      <Form.Control
          ...
          placeholder="Buy-Request Subject"
        />
...
export default BuyRequestsubject;
