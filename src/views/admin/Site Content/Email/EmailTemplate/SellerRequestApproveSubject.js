...
function SellerRequestApproveSubject() {
  const title = 'Seller Request Approve Subject (Customer, Portal Admin)';
  const description = 'Seller Request Approve Subject (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'sellerrequestapprovesubject';
...
export default SellerRequestApproveSubject;
