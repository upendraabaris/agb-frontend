...
function OrderPackedsubject() {
  const title = 'Order packed subject (Customer, Portal Admin, Seller Admin)';
  const description = 'Order packed subject (Customer, Portal Admin, Seller Admin)';
  const history = useHistory();
  const eventKey = 'orderPackedsubject';
  ...
  return (
    <>
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <div className="pt-2 small">
            (First Name: $firstname, Last Name: $lastname, Mobile No.: $mobile, Email: $email, Order Tracking Link: $orderlink, Order Id: $orderid, Company
            Name: $seller, Packed Date: $packedate, Website Name: $website)
          </div>
        </Row>
      </div>
      ...
      <Form.Control
          ...
          placeholder="Order Packed  Subject"
        />
...
export default OrderPackedsubject;
