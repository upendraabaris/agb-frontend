...
function BusinessRequestApproveSubject() {
  const title = 'Business Associate Approve Subject (Customer, Portal Admin)';
  const description = 'Business Associate Approve Subject (Customer, Portal Admin)';
  const history = useHistory();
  const eventKey = 'businessrequestapprovesubject';
...
export default BusinessRequestApproveSubject;
