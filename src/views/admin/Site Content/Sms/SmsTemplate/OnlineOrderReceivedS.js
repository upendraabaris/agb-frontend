...
function OnlineOrderReceivedS() {
  const title = 'Online Order Received Seller';
  const description = 'Ecommerce Page of Online Order Received Seller ';  
  const history = useHistory();
  const eventKey = 'onlineOrderReceivedSeller';
...
export default OnlineOrderReceivedS;
