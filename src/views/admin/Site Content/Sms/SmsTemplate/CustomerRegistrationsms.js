...
function CustomerRegistrationsms() {
  const title = 'Customer Registration SMS';
  const description = 'Ecommerce Customer Registration SMS Page';
  const history = useHistory();
  const eventKey = 'customerRegistrationsms';
    ...
    <>
      ...
      <div className="mb-3 filled form-group tooltip-end-top">
        <Form.Control
          ...
          placeholder="Customer Registration SMS"
        />
...
export default CustomerRegistrationsms;
