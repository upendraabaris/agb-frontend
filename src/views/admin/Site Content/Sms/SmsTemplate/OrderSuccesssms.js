...
function OrderSuccesssms() {
  const title = 'Order Success Customer';
  const description = 'Order Success Customer';  
  const history = useHistory();
  const eventKey = 'ordersuccesssms';
...
export default OrderSuccesssms;
