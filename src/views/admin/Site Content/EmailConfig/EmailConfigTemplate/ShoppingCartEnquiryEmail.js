...
function ShoppingCartEnquiryEmail() {
  const title = 'shopping Cart Enquiry Email';
  const description = 'shopping Cart Enquiry Email Page';
  const history = useHistory();
  const eventKey = 'sellerEnquiryEmail';
...
export default ShoppingCartEnquiryEmail;
