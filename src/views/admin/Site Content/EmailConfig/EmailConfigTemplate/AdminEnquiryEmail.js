...
function AdminEnquiryEmail() {
  const title = 'Admin Enquiry Email';
  const description = 'Admin Enquiry Email Page';
  const history = useHistory();
  const eventKey = 'adminEnquiryEmail';
...
export default AdminEnquiryEmail;
