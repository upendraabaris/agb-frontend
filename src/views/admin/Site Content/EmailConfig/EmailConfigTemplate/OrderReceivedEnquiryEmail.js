...
function OrderReceivedEnquiryEmail() {
  const title = 'Order Received Enquiry Email';
  const description = 'Order Received Enquiry Email Page';
  const history = useHistory();
  const eventKey = 'orderReceivedEnquiryEmail';
...
export default OrderReceivedEnquiryEmail;
