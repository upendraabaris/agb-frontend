...
function BulkEnquiryEmail() {
  const title = 'Bulk Enquiry Email';
  const description = 'Bulk Enquiry Email Page';
  const history = useHistory();
  const eventKey = 'bulkEnquiryEmail';
...
export default BulkEnquiryEmail;
