...
function SellerB2bEnquiryEmail() {
  const title = 'Seller/B2B Enquiry Email';
  const description = 'Seller/B2B Enquiry Email Page';
  const history = useHistory();
  const eventKey = 'sellerB2bEnquiryEmail';
...
export default SellerB2bEnquiryEmail;
