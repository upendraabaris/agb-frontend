...
function AccountsEnquiryEmail() {
  const title = 'Accounts Enquiry Email';
  const description = 'Accounts Enquiry Email Page';
  const history = useHistory();
  const eventKey = 'accountsEnquiryEmail';
...
export default AccountsEnquiryEmail;
