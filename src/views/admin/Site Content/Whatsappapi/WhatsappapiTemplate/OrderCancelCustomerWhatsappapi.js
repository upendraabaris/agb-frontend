...
function OrderCancelSms() {
  const title = 'Order Cancel Customer SMS';
  const description = 'Ecommerce Order Cancel Customer Page';  
  const history = useHistory();
  const eventKey = 'orderCancelCustomersms';
