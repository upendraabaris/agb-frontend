...
function OrderDeliveryWhatsappapi() {
  const title = 'Order Delivery WhatsApp';
  const description = 'Ecommerce Customer Registration WhatsApp API No.';
  const history = useHistory();
  const eventKey = 'orderdeliverywhatsapp';
    ...
    <>
      ...
      <div className="mb-2 filled form-group tooltip-end-top">
        <div className="small pb-2">(Create a WhatsApp template with data in this sequence: 
          1. Customer Name 2. Website Name 3. Website Name)</div>
...
export default OrderDeliveryWhatsappapi;
