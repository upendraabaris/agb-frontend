...
function CustomerRegistrationWhatsappapi() {
  const title = 'Customer Registration WhatsApp Message';
  const description = 'Ecommerce Customer Registration WhatsApp Message';
  const history = useHistory();
  const eventKey = 'customerRegistrationWhatsappapi';
  ...
  return (
    <>
      ...
      <div className="mb-2 filled form-group tooltip-end-top">
        <div className="small pb-2">(Create a WhatsApp template with data in this sequence: 1. Customer Name, 2. Website Name, 3. Website Name, 4. Website Name.</div>
...
export default CustomerRegistrationWhatsappapi;
