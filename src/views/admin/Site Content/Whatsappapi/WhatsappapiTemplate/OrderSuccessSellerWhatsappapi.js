...
function OrderSuccessSeller() {
  const title = 'Order Success Seller';
  const description = 'Order Success Seller';
  const history = useHistory();
  const eventKey = 'ordersuccesssellerWhatsappapi';
  ...
  return (
    <>
      ...
      <div className="mb-2 filled form-group tooltip-end-top">
        <div className="small pb-2">(First Name: $firstname)</div>
