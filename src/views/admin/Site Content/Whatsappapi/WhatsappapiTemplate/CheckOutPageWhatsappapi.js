...
function CheckOutPagesms() {
  const title = 'Order  Check Out Page';
  const description = 'Ecommerce Order Check Out Page SMS';  
  const history = useHistory();
  const eventKey = 'checkoutsms';
...
export default CheckOutPagesms;
