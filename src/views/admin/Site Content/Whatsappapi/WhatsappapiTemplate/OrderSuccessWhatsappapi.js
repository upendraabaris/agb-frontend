...
function OrderSuccess() {
  ...
  const description = 'Order Success';
  const history = useHistory();
  const eventKey = 'ordersuccessWhatsappapi';
    ...
    <>
      ...
      <div className="mb-2 filled form-group tooltip-end-top">
        <div className="small pb-2">(Create a WhatsApp template with data in this sequence: 
          1. Customer Name, 2. Order Id, 4. Order Date, 5. Expected Delivery Date, 6. Order Amount, 
          7. Customer Name, 8. Delivery Address, 9. Mobile No, 10. Website Name, 11. Website Name)</div>
