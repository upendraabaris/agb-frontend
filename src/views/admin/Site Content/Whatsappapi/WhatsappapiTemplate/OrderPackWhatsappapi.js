...
function OrderPackWhatsappapi() {
  const title = 'Order Pack WhatsApp';
  const description = 'Ecommerce Customer Registration WhatsApp API No.';
  const history = useHistory();
  const eventKey = 'orderpackwhatsapp';
    ...
    <>
      ...
      <div className="mb-2 filled form-group tooltip-end-top">
        <div className="small pb-2">(Create a WhatsApp template with data in this sequence: 
         1. Customer Name, 2. Order Id, 3. Order Date, 4. Packed Date, 5. Customer Name,
          6. Delivery Address, 7. Mobile Number, 8. Website Name, 9. Website Name)</div>
...
export default OrderPackWhatsappapi;
