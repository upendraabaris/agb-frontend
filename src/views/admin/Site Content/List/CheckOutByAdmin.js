...
function CheckOutByAdmin({ data, theme, modules, eventKey, refetch }) {
  ...
  return (<>
    <Card className="hover-border-primary mx-0 my-0 px-0 py-0">
      ...
      <h2 className="small-title my-2 py-2">Check Out Message on Cart</h2>
...
export default CheckOutByAdmin