              ...
              <div className="row">
                  ...
                  <Form.Group controlId="formProductClass">
                    ...
                    <Form.Select as="select" name="productClassNameID" required value={formData.productClassNameID} onChange={handleCommissionChange}>
                      ...
                      {productClassData?.getAllProductClass
                        ...
                        .map((productClass) => (  // Map sorted array to option elements
                ...
                <div className=" col-md-6 mb-2">
                  <Form.Group controlId="listingCommType">
                    ...
                    <Form.Select as="select" name="listingCommType" required disabled={formData.listingCommType} value={formData.listingCommType} onChange={handleCommissionChange}>
                ...
                <div className=" col-md-6 mb-2">
                  <Form.Group controlId="productCommType">
                    ...
                    <Form.Select name="productCommType" required disabled={formData.productCommType} value={formData.productCommType} onChange={handleCommissionChange}>
                ...
                <div className=" col-md-6 mb-2">
                  <Form.Group controlId="fixedCommType">
                    ...
                    <Form.Select name="fixedCommType" required disabled={formData.fixedCommType} value={formData.fixedCommType} onChange={handleCommissionChange}>
                ...
                <div className=" col-md-6 mb-2">
                  <Form.Group controlId="shippingCommType">
                    ...
                    <Form.Select name="shippingCommType" disabled={formData.shippingCommType} required value={formData.shippingCommType} onChange={handleCommissionChange}>
