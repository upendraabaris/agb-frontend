...
const DetailViewProduct = ({ history }) => {
  const title = 'Series Product Detail';
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/admin/series/list">
              <span className="align-middle text-dark ms-1 px-2">Back</span>
            </NavLink>
            <span className="small p-2"> / </span>
            <span className="align-middle text-dark ms-1">Series Product List</span>
          </Col>
          {/* Title End */}
        </Row>
      </div>
