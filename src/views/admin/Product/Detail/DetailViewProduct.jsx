          ...
          <Form>
            <Row>
                  ...
                  <Card.Body>
                    <div className="mb-2">
                      <Form.Group controlId="fullName">
                        ...
                        <Form.Control type="text" disabled name="fullName" value={productdetail.variant[0]?.location[0]?.sellerId.companyName || ''} />
                      </Form.Group>
                    </div>
                    <div className="mb-2">
                      <Form.Group controlId="fullName">
                        <Form.Label className="fw-bold">Product Full Name</Form.Label>
                    ...
                    <div className="row">
                      <div className="mb-2 col-md-6">
                        <Form.Group controlId="previewName">
                          <Form.Label className="fw-bold">Product Preview Name</Form.Label>
                    ...
                    <div className="mb-3">
                      <Form.Group controlId="sellerNotes">
                        <Form.Label className="fw-bold">Seller Notes</Form.Label>
                        <ReactQuill
                          modules={modules}
                          theme="snow"
                    ...
                    <div className="mb-3">
                      <Form.Group controlId="returnPolicy">
                        <Form.Label className="fw-bold">Return Policy</Form.Label>
                        <ReactQuill
                          modules={modules}
                          theme="snow"
                    ...
                    <div className="mb-3">
                      <Form.Group controlId="shippingPolicy">
                        <Form.Label className="fw-bold">Shipping Policy</Form.Label>
                        <ReactQuill
                          modules={modules}
                          theme="snow"
                    ...
                    <div className="mb-3">
                      <Form.Label className="fw-bold">FAQ</Form.Label>
                      ...
                      {/* <Button variant="primary" size="sm" className="ms-3" onClick={handleAddFaq}>
                        Add FAQ
                      </Button> */}
                    </div>
                    ...
                    <Accordion className="mb-3">
                      <Accordion.Item eventKey="1">
                        <Accordion.Header>Category Selection </Accordion.Header>
                        <Accordion.Body>
              ...
              <Col xl="4">
                <Card className="mb-3">
                  <Card.Body>
                    <Form.Label className="fw-bold">Product Preview Image</Form.Label>
                  ...
                  <Card.Body>
                    ...
                    <div className="row ms-1">
                      {productdetail.images?.map((image, i) => {
                        return (
                          <div key={i} className="col-auto p-1 m-0">
                            {/* <Button
                              variant="foreground-alternate"
                              className="btn-icon btn-icon-only shadow"
                              onClick={() => {
                  ...
                  <Card.Body>
                    ...
                    <div className="mb-3">
                      <Form.Group controlId="catalogue">
                        <Form.Label className="fw-bold">Catalogue</Form.Label>
                    ...
                    <div className="row">
                      <div className="mb-3">
                        <Form.Group controlId="giftOffer">
                          <Form.Label className="fw-bold">Gift Offer</Form.Label>
