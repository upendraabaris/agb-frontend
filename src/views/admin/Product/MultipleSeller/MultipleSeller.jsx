...
function AddSeries({ history }) {
  const title = 'Individual Product added by Multiple Sellers';
  const description = ' Individual Product added by Multipleseller';
  ...
  const [CreateSeriesProduct] = useMutation(CREATE_SERIES_PRODUCT, {
    onCompleted: (data) => {
      toast.success('Product Created Successfully !', {
        autoClose: 2000, // success toast closes quickly
      });

      setFormData(initialStates);
      const seriesId = data.createSeriesProduct.id;

      // Show mandatory variant message (before redirect, so it persists after navigation)
      setTimeout(() => {
        toast.info('Filling at least one variant is mandatory', {
          autoClose: 5000,
        });

        history.push(`/admin/product/VariantName/${seriesId}`);
      }, 2000);
    },
    onError: (error) => {
          ...
          <Form onSubmit={(e) => handleProduct(e)}>
            <Card className="mb-3 border rounded">
              ...
              <div className="mb-3 px-3" ref={fieldRefs.description}>
                ...
                <ReactQuill modules={modules} theme="snow" placeholder="Description" value={formData.description} onChange={handleDescriptionChange} />
              ...
              <div className="row px-3">
                ...
                <div className="col-md-6 mb-2">
                  <Form.Group controlId="productComm">
                    ...
                    {errors.productComm && <div className="text-danger mt-1">{errors.productComm}</div>}
                  </Form.Group>
                </div>
                ...
                <div className="col-md-6 mb-2">
                  <Form.Group controlId="listingComm">
                    ...
                    {errors.listingComm && <div className="text-danger mt-1">{errors.listingComm}</div>}
                  </Form.Group>
                </div>
                ...
                <div className="col-md-6 mb-0">
                  <Form.Group controlId="fixedComm">
                    ...
                    {errors.fixedComm && <div className="text-danger mt-1">{errors.fixedComm}</div>}
                  </Form.Group>
                </div>
                ...
                <div className="col-md-6 mb-3">
                  <Form.Group controlId="shippingComm">
                    ...
                    {errors.shippingComm && <div className="text-danger mt-1">{errors.shippingComm}</div>}
                  </Form.Group>
                </div>
              </div>
            </Card>
