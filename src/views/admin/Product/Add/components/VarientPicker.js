              ...
              <Form onSubmit={handleSubmit}>
                ...
                {formData.variant.map((variant, variantIndex) => (
                  <div key={variantIndex} className="my-3">
                    ...
                    <div className="row">
                      <div className="col-md-6 mb-2">
                        <Form.Group controlId={`variant[${variantIndex}].variantName`}>
                          <Form.Label className="fs-6">Variant Name</Form.Label>
                      ...
                      <div className="col-md-6 mb-2">
                        <Form.Group controlId={`variant[${variantIndex}].hsn`}>
                          <Form.Label className="fs-6">HSN</Form.Label>
                          <Form.Control
                            type="number"
                            onKeyPress={(e) => {
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6 mb-2">
                        <Form.Group controlId={`variant[${variantIndex}].minimunQty`}>
                          <Form.Label className="fs-6">Minimum Qty</Form.Label>
                          <Form.Control
                            type="number"
                            onWheel={(e) => e.target.blur()}
                            min={1}
                      ...
                      <div className="col-md-6 mb-2">
                        <Form.Group controlId={`variant[${variantIndex}].moq`}>
                          <Form.Label className="fs-6">MOQ</Form.Label>
                          <Form.Control
                            type="number"
                            onWheel={(e) => e.target.blur()}
                            min={1}
                    ...
                    <div className="mb-3">
                      <Form.Label className="fs-6">Salient Features</Form.Label>
                      <ReactQuill
                        modules={modules}
                        theme="snow"
                    ...
                    {variant.location.map((location, locationIndex) => (
                      <div key={locationIndex} className="my-3">
                        <h4 className='fw-bold'>Location {locationIndex + 1}</h4>
                        <div className="row">
                          <div className="col-md-6 mb-2">
                            ...
                            <div className=" col-md-6 mb-2">
                              <Form.Group controlId={`variant[${variantIndex}].location[${locationIndex}].transportChargeType`}>
                                ...
                                <Form.Select
                                  ...
                                  onChange={(e) => handleLocationChange(e, variantIndex, locationIndex)}
                                >
                                  <option hidden>Select Delivery Charge Type</option>
                                  {/* eslint-disable-next-line */}
                            ...
                            <div className=" col-md-6 mb-2">
                              <Form.Group controlId={`variant[${variantIndex}].location[${locationIndex}].finalPrice`}>
                                ...
                                <Form.Select
                                  ...
                                  onChange={(e) => handleLocationChange(e, variantIndex, locationIndex)}
                                >
                                  <option hidden>Select Final Price Type</option>
                                  {/* eslint-disable-next-line */}
                          ...
                          <div className="col-md-6 mb-2">
                            <Form.Group controlId={`variant[${variantIndex}].location[${locationIndex}].displayStock`}>
                              <Form.Label className="fs-6">Display Stock</Form.Label>
                              <Form.Control
                                type="number"
                                onWheel={(e) => e.target.blur()}
                                min={0}
                          ...
                          <div className="col-md-6 mb-2">
                            <Form.Group controlId={`variant[${variantIndex}].location[${locationIndex}].mainStock`}>
                              <Form.Label className="fs-6">Main Stock</Form.Label>
                              <Form.Control
                                type="number"
                                onWheel={(e) => e.target.blur()}
                                min={0}
                          ...
                          <div className="col-md-6 mb-3">
                            <Form.Group controlId={`variant[${variantIndex}].location[${locationIndex}].b2bdiscount`}>
                              <Form.Label className="fs-6">B2B Discount</Form.Label>
                              <Form.Control
                                type="number"
                                onWheel={(e) => e.target.blur()}
                                min={0}
                          ...
                          <div className="col-md-6 mb-3">
                            <Form.Group controlId={`variant[${variantIndex}].location[${locationIndex}].b2cdiscount`}>
                              <Form.Label className="fs-6">B2C Discount</Form.Label>
                              <Form.Control
                                type="number"
                                onWheel={(e) => e.target.blur()}
                                min={0}
