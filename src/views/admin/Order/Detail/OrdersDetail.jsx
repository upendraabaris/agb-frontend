...
const OrdersDetail = () => {
  ...
  const [UpdatePaymentProofStatus, { loading: updateLoading }] = useMutation(UPDATE_PAYMENT_PROOF, {
    onCompleted: () => {
      setmodalshow(false);
      refetch();
    ...
    <>
                                ...
                                <Row className="g-0">
                                  <Col xs="9" className="d-flex flex-row pe-2 align-items-end">
                                    <div className="text-dark">
                                      ...
                                      Qty : {cart.quantity}
                                      <br />
                                      Sold by : {cart.locationId.sellerId.companyName}
                                    </div>
                                  </Col>
      ...
      {imagepath && (
        <Modal show={imagemodal} onHide={() => setImagemodal(false)}>
          ...
          <Modal.Body className="mx-2 my-2 p-1">
            <div className="row">
              <picture>
