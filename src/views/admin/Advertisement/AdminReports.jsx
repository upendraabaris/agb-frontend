            ...
            <div className="page-wrapper">
                            ...
                            <div className="row g-3 mb-3 d-print-none">
                                ...
                                <div className="col-md-2">
                                    ...
                                    <Form.Control
                                        type="number"
                                        value={revenueYear}
                                        onChange={(e) => setRevenueYear(parseInt(e.target.value, 10))}
                                        size="sm"
                                    />
                                </div>
                                {revenuePeriod === 'monthly' && (
                                    <div className="col-md-2">
                                        ...
                                        <Form.Select
                                            value={revenueMonth}
                                            onChange={(e) => setRevenueMonth(parseInt(e.target.value, 10))}
                                            size="sm"
                                        >
                                            {[...Array(12)].map((_, i) => (
                                ...
                                {revenuePeriod === 'quarterly' && (
                                    <div className="col-md-2">
                                        ...
                                        <Form.Select
                                            ...
                                            onChange={(e) => setRevenueQuarter(parseInt(e.target.value, 10))}
                                            size="sm"
                                        >
                ...
                ========================================== */}
                        <div className="mb-5">
                            ...
                            {!tierSalesQuery.loading && tierSalesQuery.error && (
                ...
                ========================================== */}
                        <div className="mb-5">
                            ...
                            {!slotUtilizationQuery.loading && slotUtilizationQuery.error && (
                ...
                ========================================== */}
                        <div className="mb-5">
                            ...
                            {!pendingApprovalsQuery.loading && pendingApprovalsQuery.error && (
                ...
                ========================================== */}
                        <div className="mb-5">
                            ...
                            {!expiryQuery.loading && expiryQuery.error && (
                ...
                ========================================== */}
                        <div className="mb-4">
                            ...
                            {!advertiserSpendingQuery.loading && advertiserSpendingQuery.error && (
