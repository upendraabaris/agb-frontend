...
const ListViewProduct = () => {
  const title = 'Enquiry Product List';
  const description = 'Enquiry Product List';
  ...
  function handleClick() {
    history.push('/enquiry/product/add');
  }
    ...
    <>
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            <NavLink className="pb-1 d-inline-block hidden breadcrumb-back" to="/enquiry/dashboard">
              <span className="text-dark ms-1">Dashboard</span>
            </NavLink>
            <spna className='small p-2'> / </spna>
            <NavLink className="pb-1 d-inline-block hidden breadcrumb-back" to="#">
      ...
      <Row className="mb-3">
        <Col md="5" lg="6" xxl="2" className="mb-1">
          ...
          <div className="d-inline-block float-md-start me-1 mb-1 search-input-container w-100 shadow bg-foreground">
            <Form.Control
              type="text"
              placeholder="Search by Product Full Name and Brand"
              value={search}
      ...
      {/* Single Card Begins Here */}
      {
        loading ? (
          ...
          data && data.getProductEnquiryByForSeller.length > 0 && (
            <>
              {data.getProductEnquiryByForSeller
                ?.slice(0)
                .reverse()
                .map((product) => (
                        ...
                        <Row className="g-0 h-100 align-content-center">
                          <Col xs="11" lg="5" className="d-flex flex-column mb-lg-0 mb-3 pe-3 d-flex order-1 h-lg-100 justify-content-center">
                            <NavLink to={`/product/${product.identifier.replace(/\s/g, '_').toLowerCase()}`} target='_blank' className='fw-bold'>
                              {product.fullName}
                              {/* <div className="text-small text-dark text-truncate">#{product.sku}</div> */}
                            </NavLink>
                          </Col>
                          ...
                          <Col lg="1" className="d-flex flex-column justify-content-center mb-2 mb-lg-0 order-4 col-lg-3 col-6">
                            <div className="lh-1 text-alternate">{product.approve ?
                              (
      ...
      {data && (
        <div className="d-flex justify-content-center mt-5">
          <Pagination>
            ...
            <Pagination.Next className="shadow" onClick={() => handlePageChange(offset + limit)} disabled={data.getProductEnquiryByForSeller?.length < limit}>
